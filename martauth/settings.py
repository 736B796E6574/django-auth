"""
Django settings for martauth project.
...
SECRET_KEY = 'django-insecure-ackt@f4)%g1!qjc@chx5=u=w#^0^=!qtxwaxw5fwro9iyvg!l^'
...
AUTH_USER_MODEL = 'knox.CustomUser'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'knox.context_processors.custom_user',
...
WSGI_APPLICATION = 'martauth.wsgi.application'
